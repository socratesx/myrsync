...
public class addConfig extends AppCompatActivity {
    ...
    public void addPath(View v){
        ...
        startActivityForResult(i.createChooser(i,"Choose Directory"),1);
    }
    ...
    protected Map<String,String> processForm(View v){
        ...
        EditText et_srv_ip= (EditText) findViewById(R.id.ed_srv_ip);
        EditText et_srv_port= (EditText) findViewById(R.id.ed_srv_port);
        EditText et_rs_user= (EditText) findViewById(R.id.ed_rsync_user);
        EditText et_rs_mod= (EditText) findViewById(R.id.ed_rsync_mod);
    ...
    public void viewCommand(View v){
        ...
        TextView tv= (TextView) findViewById(R.id.tv_rs_cmd_View);
    ...
    protected void saveConfig(View v){
        ...
        if (!rs_user.isEmpty() && !rs_ip.isEmpty() && !rs_module.isEmpty() && !local_path.isEmpty()) {
